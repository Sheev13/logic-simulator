...
def getMockData1():
    """Get set 1 of mock data for testing the GUI; clock, switches, dtype."""
    names = Names()
    devices = Devices(names)

    names.lookup(
        ["SW1", "SW2", "SW3", "F1", "CLKasdfasdfasdfasdfasdfasdfghjkl1"]
    )
    ...
    devices.make_device(
        dNames.query("CLKasdfasdfasdfasdfasdfasdfghjkl1"),
        devices.device_types[0],
        4
    )
